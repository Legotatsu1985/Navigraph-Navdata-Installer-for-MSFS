...
from tkinter.test.support import (AbstractDefaultRootTest, get_tk_patchlevel,
                                  requires_tk, widget_eq)
from tkinter.test.widget_tests import (AbstractWidgetTest, IntegerSizeTests,
                                       PixelSizeTests, StandardOptionsTests,
                                       add_standard_options, setUpModule)
